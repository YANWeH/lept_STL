/*************************************************************************
	> File Name: algorithm_test.h
	> Author: YWH
	> Mail: 925957192@qq.com
	> Created Time: Wed 10 Aug 2022 03:20:55 AM EDT
 ************************************************************************/

#ifndef LEPTSTL_ALGORITHM_TEST_H__
#define LEPTSTL_ALGORITHM_TEST_H__ 
...
#undef min
        ...
        namespace algorithm_test 
        {
            ...
            TEST(copy_test)
            {
                ...
                leptstl::copy(arr1, arr1 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::copy(arr1 + 5, arr1 + 10, exp);
                leptstl::copy(arr1 + 5, arr1 + 10, act);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(copy_backward_test)
            {
                ...
                leptstl::copy_backward(arr1, arr1 + 5, act + 5);
                EXPECT_CON_EQ(exp, act);
                std::copy_backward(exp.begin(), exp.begin() + 8, exp.begin() + 9);
                leptstl::copy_backward(act, act + 8, act + 9);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(copy_if_test)
            {
                ...
                leptstl::copy_if(arr1, arr1 + 10, act, is_odd);
                EXPECT_CON_EQ(exp, act);
                std::copy_if(arr1, arr1 + 10, exp, is_even);
                leptstl::copy_if(arr1, arr1 + 10, act, is_even);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(copy_n_test)
            {
                ...
                leptstl::copy_n(arr1, 10, act);
                EXPECT_CON_EQ(exp, act);
                std::copy_n(arr1 + 5, 5, exp);
                leptstl::copy_n(arr1 + 5, 5, act);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(move_backward_test)
            {
                ...
                leptstl::move_backward(arr2, arr2 + 5, act + 5);
                EXPECT_CON_EQ(exp, act);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(equal_test)
            {
                ...
                EXPECT_EQ(std::equal(v1.begin(), v1.end(), v2.begin()),
                        leptstl::equal(v1.begin(), v1.end(), v2.begin()));
                EXPECT_EQ(std::equal(arr1, arr1 + 5, arr2),
                        leptstl::equal(arr1, arr1 + 5, arr2));
                EXPECT_EQ(std::equal(v1.begin(), v1.end(), arr1),
                        leptstl::equal(v1.begin(), v1.end(), arr1));
                EXPECT_EQ(std::equal(v1.begin(), v1.end(), arr2, std::equal_to<int>()),
                        leptstl::equal(v1.begin(), v1.end(), arr2, std::equal_to<int>()));
            }

            TEST(fill_test)
            {
                int exp[10], act[10];
                leptstl::vector<int> v1(10, 1);
                leptstl::vector<int> v2(10, 2);
                std::fill(exp, exp + 10, 1);
                leptstl::fill(act, act + 10, 1);
                EXPECT_CON_EQ(exp, act);
                std::fill(v1.begin(), v1.end(), 3);
                leptstl::fill(v2.begin(), v2.end(), 3);
                EXPECT_CON_EQ(v1, v2);
            }
            ...
            TEST(fill_n_test)
            {
                ...
                int arr2[5];
                std::fill_n(arr2, 5, 1);
                leptstl::fill_n(arr1, 5, 1);
                EXPECT_CON_EQ(arr1, arr2);
                std::fill_n(arr1 + 2, 3, 2);
                leptstl::fill_n(arr2 + 2, 3, 2);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(iter_swap_test)
            {
                ...
                int *p4 = &b;
                std::iter_swap(p1, p2);
                leptstl::iter_swap(p3, p4);
                EXPECT_PTRELEM_EQ(p1, p3);
                EXPECT_PTRELEM_EQ(p2, p4);
                EXPECT_EQ(p1, p3);
                EXPECT_EQ(p2, p4);
            }
            ...
            TEST(lexicographical_compare_test)
            {
                ...
                EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr2, arr2 + 5),
                      leptstl::lexicographical_compare(arr1, arr1 + 5, arr2, arr2 + 5));
                EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr3, arr3 + 5),
                      leptstl::lexicographical_compare(arr1, arr1 + 5, arr3, arr3 + 5));
                EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr4, arr4 + 6, std::less<int>()),
                      leptstl::lexicographical_compare(arr1, arr1 + 5, arr4, arr4 + 6, std::less<int>()));
                EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr5, arr5 + 3, std::less<int>()),
                      leptstl::lexicographical_compare(arr1, arr1 + 5, arr5, arr5 + 3, std::less<int>()));
            }
            ...
            TEST(max_test)
			{
  				...
  				char c1 = 'a', c2 = 'b';
  				EXPECT_EQ(std::max(i1, i2), leptstl::max(i1, i2));
  				EXPECT_EQ(std::max(d1, d2), leptstl::max(d1, d2));
  				EXPECT_EQ(std::max(c1, c2), leptstl::max(c1, c2));
			}
			...
			TEST(min_test)
            {
                ...
                double d1 = 1.1, d2 = 2.2;
                char c1 = 'a', c2 = 'b';
                EXPECT_EQ(std::min(i1, i2), leptstl::min(i1, i2));
                EXPECT_EQ(std::min(d1, d2), leptstl::min(d1, d2));
                EXPECT_EQ(std::min(c1, c2), leptstl::min(c1, c2));
            }
            ...
            TEST(mismatch_test)
            {
                ...
                auto p2 = leptstl::mismatch(arr1, arr1 + 7, arr2);
                auto p3 = std::mismatch(arr1, arr1 + 7, arr3);
                auto p4 = leptstl::mismatch(arr1, arr1 + 7, arr3);
                auto p5 = std::mismatch(arr1, arr1 + 7, arr4, std::equal_to<int>());
                auto p6 = leptstl::mismatch(arr1, arr1 + 7, arr4, std::equal_to<int>());
            ...
            TEST(make_heap_test)
            {
                ...
                leptstl::make_heap(arr2, arr2 + 9);
                std::make_heap(arr3, arr3 + 9);
                leptstl::make_heap(arr4, arr4 + 9);
                std::make_heap(arr5, arr5 + 10, std::greater<int>());
                leptstl::make_heap(arr6, arr6 + 10, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
            ...
            TEST(pop_heap_test)
            {
                ...
                leptstl::pop_heap(arr4, arr4 + 9, std::greater<int>());
                EXPECT_CON_EQ(arr3, arr4);
            }
            ...
            TEST(push_heap_test)
            {
                ...
                leptstl::push_heap(arr4, arr4 + 9, std::greater<int>());
                EXPECT_CON_EQ(arr3, arr4);
            }
            ...
            TEST(sort_heap_test)
            {
                ...
                leptstl::sort_heap(arr2, arr2 + 9);
                std::sort_heap(arr3, arr3 + 9, std::greater<int>());
                leptstl::sort_heap(arr4, arr4 + 9, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
                EXPECT_CON_EQ(arr3, arr4);
            }
            ...
            TEST(set_difference_test)
            {
                ...
                leptstl::set_difference(arr1, arr1 + 9, arr2, arr2 + 6, act);
                EXPECT_CON_EQ(exp, act);
                std::set_difference(arr2, arr2 + 6, arr3, arr3 + 3, exp);
                leptstl::set_difference(arr2, arr2 + 6, arr3, arr3 + 3, act);
                EXPECT_CON_EQ(exp, act);
                std::set_difference(arr1, arr1 + 9, arr3, arr3 + 3, exp, std::less<int>());
                leptstl::set_difference(arr1, arr1 + 9, arr3, arr3 + 3, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(set_intersection_test)
            {
                ...
                leptstl::set_intersection(arr1, arr1 + 9, arr2, arr2 + 6, act);
                EXPECT_CON_EQ(exp, act);
                std::set_intersection(arr2, arr2 + 6, arr3, arr3 + 3, exp);
                leptstl::set_intersection(arr2, arr2 + 6, arr3, arr3 + 3, act);
                EXPECT_CON_EQ(exp, act);
                std::set_intersection(arr1, arr1 + 9, arr3, arr3 + 3, exp, std::less<int>());
                leptstl::set_intersection(arr1, arr1 + 9, arr3, arr3 + 3, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(set_symmetric_difference_test)
            {
                ...
                leptstl::set_symmetric_difference(arr1, arr1 + 5, arr2, arr2 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::set_symmetric_difference(arr1, arr1 + 5, arr3, arr3 + 5, exp);
                leptstl::set_symmetric_difference(arr1, arr1 + 5, arr3, arr3 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::set_symmetric_difference(arr2, arr2 + 5, arr3, arr3 + 5, exp, std::less<int>());
                leptstl::set_symmetric_difference(arr2, arr2 + 5, arr3, arr3 + 5, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(set_union_test)
            {
                ...
                leptstl::set_union(arr1, arr1 + 5, arr2, arr2 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::set_union(arr1, arr1 + 5, arr3, arr3 + 5, exp);
                leptstl::set_union(arr1, arr1 + 5, arr3, arr3 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::set_union(arr2, arr2 + 5, arr3, arr3 + 5, exp, std::less<int>());
                leptstl::set_union(arr2, arr2 + 5, arr3, arr3 + 5, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(accumulate_test)
            {
                ...
                EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 0),
                        leptstl::accumulate(arr1, arr1 + 5, 0));
                EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 5),
                        leptstl::accumulate(arr1, arr1 + 5, 5));
                EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 0, std::minus<int>()),
                        leptstl::accumulate(arr1, arr1 + 5, 0, std::minus<int>()));
            }
            ...
            TEST(adjacent_difference_test)
            {
                ...
                leptstl::adjacent_difference(arr1, arr1 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::adjacent_difference(arr2, arr2 + 5, exp, std::minus<int>());
                leptstl::adjacent_difference(arr2, arr2 + 5, act, std::minus<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(inner_product_test)
            {
                ...
                EXPECT_EQ(std::inner_product(arr1, arr1 + 5, arr3, 0),
                        leptstl::inner_product(arr1, arr1 + 5, arr3, 0));
                EXPECT_EQ(std::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(), std::multiplies<int>()),
                        leptstl::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(), std::multiplies<int>()));
            }
            ...
            TEST(adjacent_find_test)
            {
                ...
                EXPECT_EQ(std::adjacent_find(arr1, arr1 + 5),
                      leptstl::adjacent_find(arr1, arr1 + 5));
                EXPECT_EQ(std::adjacent_find(arr2, arr2 + 5),
                      leptstl::adjacent_find(arr2, arr2 + 5));
                EXPECT_EQ(std::adjacent_find(arr1, arr1 + 5, std::greater<int>()),
                      leptstl::adjacent_find(arr1, arr1 + 5, std::greater<int>()));
            }
            ...
            TEST(all_of_test)
            {
                ...
                EXPECT_EQ(std::all_of(arr1, arr1 + 5, is_odd),
                      leptstl::all_of(arr1, arr1 + 5, is_odd));
                EXPECT_EQ(std::all_of(arr2, arr2 + 5, is_odd),
                      leptstl::all_of(arr2, arr2 + 5, is_odd));
            }
            ...
            TEST(any_of_test)
            {
                ...
                EXPECT_EQ(std::any_of(arr1, arr1 + 5, is_odd),
                      leptstl::any_of(arr1, arr1 + 5, is_odd));
                EXPECT_EQ(std::any_of(arr2, arr2 + 5, is_odd),
                      leptstl::any_of(arr2, arr2 + 5, is_odd));
            }
            ...
            TEST(binary_search_test)
            {
                ...
                EXPECT_EQ(std::binary_search(arr1, arr1 + 5, 1),
                      leptstl::binary_search(arr1, arr1 + 5, 1));
                EXPECT_EQ(std::binary_search(arr1, arr1 + 5, 6),
                      leptstl::binary_search(arr1, arr1 + 5, 6));
            }
            ...
            TEST(count_test)
            {
                ...
                EXPECT_EQ(std::count(arr1, arr1 + 9, 2),
                      (long)leptstl::count(arr1, arr1 + 9, 2));
                EXPECT_EQ(std::count(arr1, arr1 + 9, 3),
                      (long)leptstl::count(arr1, arr1 + 9, 3));
                EXPECT_EQ(std::count(arr1, arr1 + 9, 6),
                      (long)leptstl::count(arr1, arr1 + 9, 6));
            }
            ...
            TEST(count_if_test)
            {
                ...
                EXPECT_EQ(std::count_if(arr1, arr1 + 9, is_odd),
                      (long)leptstl::count_if(arr1, arr1 + 9, is_odd));
                EXPECT_EQ(std::count_if(arr1, arr1 + 9, is_even),
                      (long)leptstl::count_if(arr1, arr1 + 9, is_even));
            }

            TEST(equal_range_test)
            {
                int arr1[] = { 1,2,3,3,3,4,5 };
                auto p1 = leptstl::equal_range(arr1, arr1 + 7, 3);
                auto p2 = std::equal_range(arr1, arr1 + 7, 3);
                auto p3 = leptstl::equal_range(arr1, arr1 + 7, 6, std::equal_to<int>());
            ...
            {
                int arr1[] = { 1,2,3,4,5 };
                EXPECT_EQ(std::find(arr1, arr1 + 5, 3), leptstl::find(arr1, arr1 + 5, 3));
                EXPECT_EQ(std::find(arr1, arr1 + 5, 6), leptstl::find(arr1, arr1 + 5, 6));
            }
            ...
            TEST(find_end_test)
            {
                ...
                EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr2, arr2 + 1),
                      leptstl::find_end(arr1, arr1 + 8, arr2, arr2 + 1));
                EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3 + 2),
                      leptstl::find_end(arr1, arr1 + 8, arr3, arr3 + 2));
                EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3 + 2),
                      leptstl::find_end(arr1, arr1 + 8, arr3, arr3 + 2));
                EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3, std::less<int>()),
                      leptstl::find_end(arr1, arr1 + 8, arr3, arr3, std::less<int>()));
            }
            ...
            TEST(find_first_of_test)
            {
                ...
                EXPECT_EQ(std::find_first_of(arr1, arr1 + 5, arr2, arr2 + 3),
                      leptstl::find_first_of(arr1, arr1 + 5, arr2, arr2 + 3));
                EXPECT_EQ(std::find_first_of(arr1, arr1 + 5, arr3, arr3 + 3, std::equal_to<int>()),
                      leptstl::find_first_of(arr1, arr1 + 5, arr3, arr3 + 3, std::equal_to<int>()));
            }
            ...
            TEST(find_if_test)
            {
                ...
                EXPECT_EQ(std::find_if(arr1, arr1 + 5, is_odd),
                      leptstl::find_if(arr1, arr1 + 5, is_odd));
                EXPECT_EQ(std::find_if(arr1, arr1 + 5, is_even),
                      leptstl::find_if(arr1, arr1 + 5, is_even));
            }
            ...
            TEST(find_if_not_test)
            {
                ...
                EXPECT_EQ(std::find_if_not(arr1, arr1 + 5, is_odd),
                      leptstl::find_if_not(arr1, arr1 + 5, is_odd));
                EXPECT_EQ(std::find_if_not(arr1, arr1 + 5, is_even),
                      leptstl::find_if_not(arr1, arr1 + 5, is_even));
            }
            ...
            TEST(for_each_test)
            {
                ...
                leptstl::for_each(v1.begin(), v1.end(), arr_sum);
            ...
            TEST(generate_test)
            {
                ...
                leptstl::generate(arr2, arr2 + 5, gen);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(includes_test)
            {
                ...
                EXPECT_EQ(std::includes(v1.begin(), v1.end(), v2.begin(), v2.end()),
                      leptstl::includes(v1.begin(), v1.end(), v2.begin(), v2.end()));
                EXPECT_EQ(std::includes(v1.begin(), v1.end(), v3.begin(), v3.end()),
                      leptstl::includes(v1.begin(), v1.end(), v3.begin(), v3.end()));
                EXPECT_EQ(std::includes(v1.begin(), v1.end(), v4.begin(), v4.end()),
                      leptstl::includes(v1.begin(), v1.end(), v4.begin(), v4.end()));
                EXPECT_EQ(std::includes(v1.begin(), v1.end(), v5.begin(), v5.end(), std::less<int>()),
                      leptstl::includes(v1.begin(), v1.end(), v5.begin(), v5.end(), std::less<int>()));
            }
            ...
            TEST(inplace_merge_test)
            {
                ...
                leptstl::inplace_merge(arr2, arr2 + 5, arr2 + 10);
                std::inplace_merge(arr3, arr3 + 3, arr3 + 8, std::less<int>());
                leptstl::inplace_merge(arr4, arr4 + 3, arr4 + 8, std::less<int>());
                EXPECT_CON_EQ(arr1, arr2);
                EXPECT_CON_EQ(arr3, arr4);
            }
            ...
            TEST(is_heap_test)
            {
                ...
                EXPECT_EQ(std::is_heap(arr1, arr1 + 10), leptstl::is_heap(arr1, arr1 + 10));
                EXPECT_EQ(std::is_heap(arr2, arr2 + 10, std::less<int>()),
                      leptstl::is_heap(arr2, arr2 + 10, std::less<int>()));
                EXPECT_EQ(std::is_heap(arr3, arr3 + 10), leptstl::is_heap(arr3, arr3 + 10));
                EXPECT_EQ(std::is_heap(arr4, arr4 + 10), leptstl::is_heap(arr4, arr4 + 10));
            }
            ...
            TEST(is_sorted_test)
            {
                ...
                int arr3[] = { 5,4,3,2,1 };
                int arr4[] = { 1,2,5,4,3 };
                EXPECT_EQ(std::is_sorted(arr1, arr1 + 5), leptstl::is_sorted(arr1, arr1 + 5));
                EXPECT_EQ(std::is_sorted(arr2, arr2 + 5), leptstl::is_sorted(arr2, arr2 + 5));
                EXPECT_EQ(std::is_sorted(arr3, arr3 + 5, std::less<int>()),
                      leptstl::is_sorted(arr3, arr3 + 5, std::less<int>()));
                EXPECT_EQ(std::is_sorted(arr4, arr4 + 5, std::less<int>()),
                      leptstl::is_sorted(arr4, arr4 + 5, std::less<int>()));
            }
            ...
            TEST(lower_bound_test)
            {
                ...
                EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 1),
                      leptstl::lower_bound(arr1, arr1 + 7, 1));
                EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 2),
                      leptstl::lower_bound(arr1, arr1 + 7, 2));
                EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 3),
                      leptstl::lower_bound(arr1, arr1 + 7, 3));
                EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 5, std::less<int>()),
                      leptstl::lower_bound(arr1, arr1 + 7, 5, std::less<int>()));
            }
            ...
            TEST(max_elememt_test)
            {
                ...
                EXPECT_PTRELEM_EQ(std::max_element(arr1, arr1 + 9),
                              leptstl::max_element(arr1, arr1 + 9));
                EXPECT_PTRELEM_EQ(std::max_element(arr2, arr2 + 6, std::less<double>()),
                              leptstl::max_element(arr2, arr2 + 6, std::less<double>()));
            }
            ...
            TEST(median_test)
            {
                ...
                EXPECT_EQ(2, leptstl::median(ia, ib, ic));
                EXPECT_EQ(3.1, leptstl::median(da, db, dc, std::greater<double>()));
            }
            ...
            TEST(merge_test)
            {
                ...
                leptstl::merge(arr3, arr3 + 5, arr4, arr4 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::merge(arr1, arr1 + 5, arr2, arr2 + 5, exp, std::less<int>());
                leptstl::merge(arr3, arr3 + 5, arr4, arr4 + 5, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(is_permutation_test)
            {
                ...
                EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr2),
                          leptstl::is_permutation(arr1, arr1 + 5, arr2, arr2 + 5));
                EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr3),
                          leptstl::is_permutation(arr1, arr1 + 5, arr3, arr3 + 5));
                EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr2, std::equal_to<int>()),
                          leptstl::is_permutation(arr1, arr1 + 5, arr2, arr2 + 5, std::equal_to<int>()));
                EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr3, std::equal_to<int>()),
                          leptstl::is_permutation(arr1, arr1 + 5, arr3, arr3 + 5, std::equal_to<int>()));
            }
            ...
            TEST(next_permutation_test)
            {
                ...
                while (leptstl::next_permutation(arr1, arr1 + 4))    n2++;
                EXPECT_EQ(n1, n2);
                for (; n1 > 0; n1--)
                {
                    std::next_permutation(arr1, arr1 + 4);
                    leptstl::next_permutation(arr2, arr2 + 4);
                    EXPECT_CON_EQ(arr1, arr2);
                }
                std::next_permutation(arr1, arr1 + 4, std::greater<int>());
                leptstl::next_permutation(arr2, arr2 + 4, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(none_of_test)
			{
	  		    ...
	  		    EXPECT_EQ(std::none_of(arr1, arr1 + 5, is_even),
	  		          leptstl::none_of(arr1, arr1 + 5, is_even));
	  		    EXPECT_EQ(std::none_of(arr2, arr2 + 5, is_even),
	  		          leptstl::none_of(arr2, arr2 + 5, is_even));
	  		    EXPECT_EQ(std::none_of(arr3, arr3 + 5, is_even),
	  		          leptstl::none_of(arr3, arr3 + 5, is_even));
			}
			...
			TEST(nth_element_test)
			{
			    ...
			    leptstl::nth_element(arr1, arr1 + 4, arr1 + 9);
			    leptstl::nth_element(arr2, arr2 + 2, arr2 + 9);
			    leptstl::nth_element(arr3, arr3 + 8, arr3 + 9, std::less<int>());
			    leptstl::nth_element(arr4, arr4 + 3, arr4 + 16, std::less<int>());
			...
			TEST(partial_sort_test)
			{
			    ...
			    leptstl::partial_sort(arr2, arr2 + 2, arr2 + 9);
			    std::partial_sort(arr3, arr3 + 5, arr3 + 13, std::greater<int>());
			    leptstl::partial_sort(arr4, arr4 + 5, arr4 + 13, std::greater<int>());
			    EXPECT_CON_EQ(arr1, arr2);
			    EXPECT_CON_EQ(arr3, arr4);
			}
			...
			TEST(partial_sort_copy_test)
			{
			    ...
			    leptstl::partial_sort_copy(arr1, arr1 + 9, act, act + 5);
			    EXPECT_CON_EQ(exp, act);
			    std::partial_sort_copy(arr2, arr2 + 9, exp, exp + 5);
			    leptstl::partial_sort_copy(arr2, arr2 + 9, act, act + 5);
			    EXPECT_CON_EQ(exp, act);
			    std::partial_sort_copy(arr3, arr3 + 15, exp, exp + 5, std::greater<int>());
			    leptstl::partial_sort_copy(arr3, arr3 + 15, act, act + 5, std::greater<int>());
			    EXPECT_CON_EQ(exp, act);
			}
			...
			TEST(partition_test)
			{
			    ...
			    leptstl::partition(arr2, arr2 + 9, is_odd);
			    EXPECT_CON_EQ(arr1, arr2);
			    std::partition(arr1, arr1 + 9, is_even);
			    leptstl::partition(arr2, arr2 + 9, is_even);
			    EXPECT_CON_EQ(arr1, arr2);
			}
			...
			TEST(partition_copy_test)
			{
			    ...
			    leptstl::partition_copy(arr1, arr1 + 10, act_true, act_false, is_odd);
			...
			TEST(prev_permutation_test)
			{
			    ...
			    while (leptstl::prev_permutation(arr1, arr1 + 4))    n2++;
			    EXPECT_EQ(n1, n2);
			    for (; n1 > 0; n1--)
			    {
			      	std::prev_permutation(arr1, arr1 + 4);
			      	leptstl::prev_permutation(arr2, arr2 + 4);
			      	EXPECT_CON_EQ(arr1, arr2);
			    }
			    std::prev_permutation(arr1, arr1 + 4, std::greater<int>());
			    leptstl::prev_permutation(arr2, arr2 + 4, std::greater<int>());
			    EXPECT_CON_EQ(arr1, arr2);
			}
            ...
            TEST(random_shuffle_test)
            {
                ...
                for (int i = 0; i < 9; ++i)
                {
                    ...
                    leptstl::random_shuffle(arr1, arr1 + 9);
                    EXPECT_CON_NE(arr1, arr2);
                }
                std::copy(arr1, arr1 + 9, arr2);
                leptstl::random_shuffle(arr1, arr1 + 9, r);
                EXPECT_CON_NE(arr1, arr2);
            }
            ...
            TEST(remove_test)
            {
                ...
                leptstl::remove(v2.begin(), v2.end(), 3);
                EXPECT_CON_EQ(v1, v2);
                std::remove(v1.begin(), v1.end(), 6);
                leptstl::remove(v2.begin(), v2.end(), 6);
                EXPECT_CON_EQ(v1, v2);
            }
            ...
            TEST(remove_copy_test)
            {
                ...
                leptstl::remove_copy(arr2, arr2 + 8, act, 6);
                EXPECT_CON_EQ(exp, act);
                std::remove_copy(arr1, arr1 + 5, exp, 3);
                leptstl::remove_copy(arr2, arr2 + 5, act, 3);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(remove_copy_if_test)
            {
                ...
                leptstl::remove_copy_if(arr1, arr1 + 10, act, is_odd);
                EXPECT_CON_EQ(exp, act);
                std::remove_copy_if(arr1, arr1 + 10, exp, is_even);
                leptstl::remove_copy_if(arr1, arr1 + 10, act, is_even);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(remove_if_test)
            {
                ...
                leptstl::remove_if(v2.begin(), v2.end(), is_odd);
                EXPECT_CON_EQ(v1, v2);
            }
            ...
            TEST(replace_test)
            {
                ...
                leptstl::replace(arr2, arr2 + 9, 1, 4);
                EXPECT_CON_EQ(arr1, arr2);
                std::replace(arr1, arr1 + 9, 2, 5);
                leptstl::replace(arr2, arr2 + 9, 2, 5);
                EXPECT_CON_EQ(arr1, arr2);
                std::replace(arr1, arr1 + 9, 3, 6);
                leptstl::replace(arr2, arr2 + 9, 3, 6);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(replace_copy_test)
            {
                ...
                leptstl::replace_copy(arr1, arr1 + 9, act, 1, 4);
                EXPECT_CON_EQ(exp, act);
                std::replace_copy(arr1, arr1 + 9, exp, 2, 5);
                leptstl::replace_copy(arr1, arr1 + 9, act, 2, 5);
                EXPECT_CON_EQ(exp, act);
                std::replace_copy(arr1, arr1 + 9, exp, 3, 6);
                leptstl::replace_copy(arr1, arr1 + 9, act, 3, 6);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(replace_copy_if_test)
            {
                ...
                leptstl::replace_copy_if(arr1, arr1 + 10, act, is_odd, 1);
                EXPECT_CON_EQ(exp, act);
                std::replace_copy_if(arr1, arr1 + 10, exp, is_even, 2);
                leptstl::replace_copy_if(arr1, arr1 + 10, act, is_even, 2);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(replace_if_test)
            {
                ...
                leptstl::replace_if(v2.begin(), v2.end(), is_odd, 1);
                EXPECT_CON_EQ(v1, v2);
                std::replace_if(v1.begin(), v1.end(), is_even, 2);
                leptstl::replace_if(v2.begin(), v2.end(), is_even, 2);
                EXPECT_CON_EQ(v1, v2);
            }
            ...
            TEST(reverse_test)
            {
                ...
                leptstl::reverse(arr2, arr2 + 9);
                EXPECT_CON_EQ(arr1, arr2);
                std::reverse(arr1, arr1 + 5);
                leptstl::reverse(arr2, arr2 + 5);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(reverse_copy_test)
            {
                ...
                leptstl::reverse_copy(arr1, arr1 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::reverse_copy(arr1 + 4, arr1 + 9, exp);
                leptstl::reverse_copy(arr1 + 4, arr1 + 9, act);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(rotate_test)
            {
                ...
                leptstl::rotate(arr2, arr2 + 3, arr2 + 9);
                EXPECT_CON_EQ(arr1, arr2);
                std::rotate(arr1 + 3, arr1 + 5, arr1 + 9);
                leptstl::rotate(arr2 + 3, arr2 + 5, arr2 + 9);
                EXPECT_CON_EQ(arr1, arr2);
                std::rotate(arr1, arr1 + 9, arr1 + 9);
                leptstl::rotate(arr2, arr2 + 9, arr2 + 9);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(rotate_copy_test)
            {
                ...
                leptstl::rotate_copy(arr1, arr1 + 5, arr1 + 9, act);
                EXPECT_CON_EQ(exp, act);
                std::rotate_copy(arr1, arr1, arr1 + 9, exp);
                leptstl::rotate_copy(arr1, arr1, arr1 + 9, act);
                EXPECT_CON_EQ(exp, act);
                std::rotate_copy(arr1, arr1 + 9, arr1 + 9, exp);
                leptstl::rotate_copy(arr1, arr1 + 9, arr1 + 9, act);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(search_test)
            {
                ...
                EXPECT_EQ(std::search(arr1, arr1 + 9, arr2, arr2 + 1),
                      leptstl::search(arr1, arr1 + 9, arr2, arr2 + 1));
                EXPECT_EQ(std::search(arr1, arr1 + 9, arr3, arr3 + 2),
                      leptstl::search(arr1, arr1 + 9, arr3, arr3 + 2));
                EXPECT_EQ(std::search(arr1, arr1 + 9, arr4, arr4 + 3, std::less<int>()),
                      leptstl::search(arr1, arr1 + 9, arr4, arr4 + 3, std::less<int>()));
                EXPECT_EQ(std::search(arr1, arr1 + 9, arr4, arr4 + 4, std::less<int>()),
                      leptstl::search(arr1, arr1 + 9, arr4, arr4 + 4, std::less<int>()));
            }
            ...
            TEST(search_n_test)
            {
                ...
                EXPECT_EQ(std::search_n(arr1, arr1 + 9, 1, 0),
                      leptstl::search_n(arr1, arr1 + 9, 1, 0));
                EXPECT_EQ(std::search_n(arr1, arr1 + 9, 2, 2),
                      leptstl::search_n(arr1, arr1 + 9, 2, 2));
                EXPECT_EQ(std::search_n(arr1, arr1 + 9, 1, 3),
                      leptstl::search_n(arr1, arr1 + 9, 1, 3));
                EXPECT_EQ(std::search_n(arr1, arr1 + 9, 3, 6, std::less<int>()),
                      leptstl::search_n(arr1, arr1 + 9, 3, 6, std::less<int>()));
                EXPECT_EQ(std::search_n(arr1, arr1 + 9, 2, 10, std::less<int>()),
                      leptstl::search_n(arr1, arr1 + 9, 2, 10, std::less<int>()));
            }
            ...
            TEST(sort_test)
            {
                ...
                leptstl::sort(arr2, arr2 + 14);
                std::sort(arr3, arr3 + 20);
                leptstl::sort(arr4, arr4 + 20);
                std::sort(arr5, arr5 + 9, std::greater<int>());
                leptstl::sort(arr6, arr6 + 9, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
                EXPECT_CON_EQ(arr3, arr4);
                EXPECT_CON_EQ(arr5, arr6);
            }
            ...
            TEST(swap_ranges_test)
            {
                ...
                leptstl::swap_ranges(arr2, arr2 + 6, arr4);
                std::swap_ranges(arr1, arr1 + 3, arr5);
                leptstl::swap_ranges(arr2, arr2 + 3, arr6);
                EXPECT_CON_EQ(arr1, arr2);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(transform_test)
            {
                ...
                leptstl::transform(arr1, arr1 + 9, act, unary_op);
                EXPECT_CON_EQ(exp, act);
                std::transform(arr1, arr1 + 9, arr2, exp, binary_op);
                leptstl::transform(arr1, arr1 + 9, arr2, act, binary_op);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(unique_copy_test)
            {
                ...
                leptstl::unique_copy(arr1, arr1 + 10, act);
                EXPECT_CON_EQ(exp, act);
                std::unique_copy(arr2, arr2 + 9, exp, std::equal_to<int>());
                leptstl::unique_copy(arr2, arr2 + 9, act, std::equal_to<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(upper_bound_test)
            {
                ...
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 0),
                      leptstl::upper_bound(arr1, arr1 + 9, 0));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 1),
                      leptstl::upper_bound(arr1, arr1 + 9, 1));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 3),
                      leptstl::upper_bound(arr1, arr1 + 9, 3));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 6, std::less<int>()),
                      leptstl::upper_bound(arr1, arr1 + 9, 6, std::less<int>()));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 7, std::less<int>()),
                      leptstl::upper_bound(arr1, arr1 + 9, 7, std::less<int>()));
            }
...
#endif  /* LEPTSTL_ALGORITHM_TEST_H__ */
