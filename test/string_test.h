/*************************************************************************
	> File Name: string_test.h
	> Author: YWH
	> Mail: 925957192@qq.com
	> Created Time: Tue 16 Aug 2022 02:50:27 AM EDT
 ************************************************************************/

#ifndef LEPTSTL_STRING_TEST_H__
#define LEPTSTL_STRING_TEST_H__ 

#include <string>

#include "../leptSTL/leptstring.h"
#include "lept_test.h"
...
namespace leptstl 
{
    namespace test 
    {
        namespace string_test 
        {
            ...
            {
                cout << "[===============================================================]" << std::endl;
                cout << "[----------------- Run container test : string -----------------]" << std::endl;
                cout << "[-------------------------- API test ---------------------------]" << std::endl;
                const char* s = "abcdefg";
                leptstl::string str;
                leptstl::string str1(5, 'a');
                leptstl::string str2(str1, 3);
                leptstl::string str3(str1, 0, 3);
                leptstl::string str4("abc");
                leptstl::string str5("abcde",3);
                leptstl::string str6(s, s + 5);
                leptstl::string str7(str1);
                leptstl::string str8(std::move(str1));
                leptstl::string str9;
                str9 = str2;
                leptstl::string str10;
                str10 = std::move(str2);
                leptstl::string str11;
                str11 = "123";
                leptstl::string str12;
                str12 = 'A';
                ...
                STR_FUN_AFTER(str, str.replace(0, 1, "lept "));
                ...
                /*************************************************************/
                cout << "==========KMP vs find==========" << std::endl;
                FUN_VALUE(str.find(str3));
                FUN_VALUE(str.kmp(str3, 0, str3.size()));
                FUN_VALUE(str.kmp(str3, 2, str3.size()));
                FUN_VALUE(str.kmp(str3, 3, str3.size()));
                FUN_VALUE(str.kmp(str3, 4, str3.size()));
                cout << "========end KMP vs find========" << std::endl;
                /*************************************************************/
                ...
                cout << " '#' + str3 : " << '#' + str3 << std::endl;
                cout << " str3 + \" success\" : " << str3 + " success" << std::endl;
                cout << " \"My \" + str3 : " << "My " + str3 << std::endl;
                cout << " str3 + str4 : " << str3 + str4 << std::endl;
                /*PASSED;
              #ifPERFORMANCE_TEST_ON
                ...
                PASSED;
              #endif
                cout << "[----------------- End container test : string -----------------]" << std::endl;*/
            }
